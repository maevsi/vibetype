  ...
  <div v-else class="flex flex-1 flex-col">
    ...
    <div class="flex flex-1 flex-col items-center justify-between px-6 py-8">
      ...
      >
        ...
        <IconLogoText aria-hidden="true" class="mb-12 h-6.5" />
        ...
        >
          {{ t('taglinePre') }}
          <span class="text-green-700 line-through">{{
            t('taglineFomo')
          }}</span>
          {{ t('taglinePost') }}
        </p>
...
de:
  ...
  welcomeWithSiteName: Willkommen bei @.upper:{'globalSiteName'}
en:
  ...
  welcome: Welcome to
  welcomeWithSiteName: Welcome to @.upper:{'globalSiteName'}
</i18n>
