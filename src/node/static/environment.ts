console.log('node', import.meta.envName)
export const IS_IN_PRODUCTION = import.meta.envName === 'production'
...
export const NUXT_PUBLIC_VIO_ENVIRONMENT = import.meta.envName
