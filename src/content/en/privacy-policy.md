...
1. **General information**
    ...
    1. **This is how data is basically processed on this website**
    ...
    1. **Legal basis**
        ...
        <ol type="a">
        <li>The data subject has given his/her consent to the processing of personal data concerning him/her for one or more specific purposes;</li>
        ...
        <li>processing is necessary for compliance with a legal obligation to whichthe person responsible is subject to;</li>

        <li>the processing is necessary in order to protect the vital interests of the data subject or another natural person;</li>

        <li>processing is necessary for the performance of a task carried out in the public interest or in the exercise of official authority vested inthe person in charge was transferred;</li>

        <li>processing is necessary for the purposes of safeguarding the legitimate interests ofof the responsible person(s) orof a/an third party necessary, unless the interests or fundamental rights and freedoms of the data subject which require the protection of personal data override this, in particular where the data subject is a child.</li>
        </ol>
...
1. **What happens on our website**
    ...
    1. **Cookies**
        ...
        1. **Reject cookies**
            ...
            Alternatively, you can manage your cookie settings also under http://www.aboutads.info/choices/ or http://www.youronlinechoices.com.
        ...
        1. **Technically unnecessary cookies**
    ...
    1. **Data processing through user input**
        ...
        1. **Contact**
            ...
            Monday.com Labs Ltd, 52 Menachem Begin Road, Tel Aviv 6713701, Israel. https://monday.com/l/de/privatsphaere/datenschutzerklarung/.
        ...
        1. **Questionnaires/forms**
            ...
            The stored data can be made available at any time by e-mail or a request can be made to delete the data.</li>
            </ol>
    ...
    1. **Analysis and tracking tools**
        ...
        1. **Google Analytics**
            ...
            Further information on the use of data by Googleyou will findalso under https://support.google.com/analytics/answer/6004245?hl=de. For all further questions you can also turn directly to support-deutschland@google.com.
    ...
    1. **Facebook**
        ...
        1. **Page Insights**
            ...
            We have concluded a corresponding agreement with Facebook for this purpose, which can be viewed here (https://www.facebook.com/legal/terms/page\_controller\_addendum).
    ...
    1. **Instagram**
        ...
        1. **Insights**
            ...
            As explained in the Meta Privacy Policy under "How do we use your information?" (https://privacycenter.instagram.com/policy/?entry\_point=ig\_help\_center\_data\_policy\_redirect), Meta also collects and uses information to provide analytics services, known as insights, for site operators. This also applies to our Instagram profile.
            ...
            We have concluded a corresponding agreement with Meta, which can be viewed here (https://www.facebook.com/legal/terms/page\_controller\_addendum).
            ...
            https://privacycenter.instagram.com/policy/?entry\_point=ig\_help\_center\_data\_policy\_redirect
    ...
    1. **TikTok**
        ...
        1. **Processing of personal data by TikTok**
...
1. **What if tomorrow the GDPR is abolished or other changes take place?**
