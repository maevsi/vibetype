...
describe('getPasswordStrengthScore', () => {
  test('scores a common password below the minimum', async () => {
    expect(await getPasswordStrengthScore(WEAK_PASSWORD, 'en')).toBeLessThan(
      PASSWORD_STRENGTH_SCORE_MINIMUM,
    )
  })
